<x-app-layout>
    <h1 class="text-center mb-10 font-semibold text-3xl">Input Sales</h1>
    <form id="currency-form" class="max-w-sm mx-auto" method="POST" action="{{ route('sales.store') }}">
        @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="nominal" name="nominal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Rp" type-currency="IDR" required />
        </div>
